...
public class MinecraftServerInstance {
  ...
  private Map<String, String> getLabels(ServerInstanceDto instance) {
    ...
    labels.put(MinecraftServerLabel.LABEL_SERVER_MINECRAFT_EULA,
        Boolean.toString(instance.isEula()));
    ...
    if (instance.getModrinthProjectId() != null) {
      labels.put(MinecraftServerLabel.LABEL_SERVER_MODRINTH_PROJECT_ID,
          instance.getModrinthProjectId());
    }
